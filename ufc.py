...
class UFCSimAppProHelper:
    ...
    def build_sim_app_pro_ufc_payload(self, sim_app_pro_ufc_data_map):
        ...
        #return option1 + option4 + option5 + com1 + com2 + scratch_digits + scratch_left_string + scratch_right_string + cued_windows_payload
       
       #return config.dispStr + com1 + com2 + scratch_digits + scratch_left_string + scratch_right_string + cued_windows_payload
